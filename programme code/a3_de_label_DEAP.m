...
load D:\EEGRecognition\Project_2103\features\de_2s\try\p1
...
for zq=2:32
eval(['load D:\EEGRecognition\Project_2103\features\de_2s\try\p' num2str(zq) ''])
...
load D:\EEGRecognition\Project_2103\labels\20s\DEAP\p1
y_arousal=arousal;
y_valence=valence;
for zq=2:32
eval(['load D:\EEGRecognition\Project_2103\labels\20s\DEAP\p' num2str(zq) ''])
y_arousal=[y_arousal;arousal];
y_valence=[y_valence;valence];
end
arousal=y_arousal;
valence=y_valence;
save D:\EEGRecognition\Project_2103\labeled_features\de_2s\try\data x theta alpha beta gamma arousal valence