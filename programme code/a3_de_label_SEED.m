...
load E:\Matlab_projects\Project_202103\features\de\SEED\p1
...
eval(['load E:\Matlab_projects\Project_202103\features\de\SEED\p' num2str(zq) ''])
feature=zscore(feature);
feature(valence==-1,:) = [];
valence(valence==-1,:) = [];
x=[x;feature];
...
save E:\Matlab_projects\Project_202103\labeled_features\de\SEED\data x y_valence