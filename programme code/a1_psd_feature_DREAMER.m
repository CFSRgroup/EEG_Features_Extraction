...
%载入数据集
clear feature
eval(['load E:\EEGrecognition\dataset\dataset_DREAMER\DREAMER' num2str(zq)])
...
powers(i2,:)=reshape(power',1,32*4);%汇总所有功率特征,按导联次序排列128
end
...
feature((z1-1)*40+1:z1*40,:)=eeg_powers;
end
eval(['save E:\Matlab_projects\Project_202103\features\psd\DEAP\p' num2str(zq) ' feature'])
end